...
/**
 * Wraps a plain glass {@link BakedModel} and swaps the "opaque" face for the quads of a
 * mimicked block state stored on the block entity.
 */
public class OneWayBakedModel implements BakedModel {
    private final BakedModel glassModel; // source of the glass quads
    ...
    public @NotNull List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side,
                                             @NotNull RandomSource rand, @NotNull ModelData data, @Nullable RenderType layer) {
    ...
    @Override
    public @NotNull List<BakedQuad> getQuads(@Nullable BlockState s, @Nullable Direction side, @NotNull RandomSource r) {
    ...
    @Override public @NotNull TextureAtlasSprite getParticleIcon() { return glassModel.getParticleIcon(); }
    @Override public @NotNull ItemTransforms getTransforms()       { return glassModel.getTransforms(); }
    @Override public @NotNull ItemOverrides  getOverrides()        { return glassModel.getOverrides(); }
}
